...
class EmailMessage(object):
    ...
    def __init__(self, id=None, _from=None, to=None, cc=None, bcc=None, subject=None, saved_by=None, original_inbox=None, inbox=None, domain=None, received=None, size=None, attachments=None, ip=None, via=None, folder='inbox', labels=None, read=None, rtls=None, links=None, spam=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this EmailMessage.  # noqa: E501


        :return: The id of this EmailMessage.  # noqa: E501
        :rtype: MessageId
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this EmailMessage.  # noqa: E501
        :type: MessageId
        """
    ...
    @property
    def saved_by(self):
        """Gets the saved_by of this EmailMessage.  # noqa: E501

        Indicates a starred message by your account Account._id. Otherwise `null`.  # noqa: E501

        :return: The saved_by of this EmailMessage.  # noqa: E501
        :rtype: str
        """
    ...
    def saved_by(self, saved_by):
        """Sets the saved_by of this EmailMessage.

        Indicates a starred message by your account Account._id. Otherwise `null`.  # noqa: E501

        :param saved_by: The saved_by of this EmailMessage.  # noqa: E501
        :type: str
        """
    ...
    def original_inbox(self):
        """Gets the original_inbox of this EmailMessage.  # noqa: E501

        Same as inbox unless sent to the encryptedInbox, in which case it would be the encryptedInbox.  # noqa: E501

        :return: The original_inbox of this EmailMessage.  # noqa: E501
        :rtype: str
        """
    ...
    def original_inbox(self, original_inbox):
        """Sets the original_inbox of this EmailMessage.

        Same as inbox unless sent to the encryptedInbox, in which case it would be the encryptedInbox.  # noqa: E501

        :param original_inbox: The original_inbox of this EmailMessage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def inbox(self):
        """Gets the inbox of this EmailMessage.  # noqa: E501

        Email address to which this message belongs.  # noqa: E501

        :return: The inbox of this EmailMessage.  # noqa: E501
        :rtype: str
        """
        return self._inbox
    ...
    def inbox(self, inbox):
        """Sets the inbox of this EmailMessage.

        Email address to which this message belongs.  # noqa: E501

        :param inbox: The inbox of this EmailMessage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def domain(self):
        """Gets the domain of this EmailMessage.  # noqa: E501

        hostname domain for the inbox  # noqa: E501

        :return: The domain of this EmailMessage.  # noqa: E501
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this EmailMessage.

        hostname domain for the inbox  # noqa: E501

        :param domain: The domain of this EmailMessage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def received(self):
        """Gets the received of this EmailMessage.  # noqa: E501


        :return: The received of this EmailMessage.  # noqa: E501
        :rtype: ModelDate
        """
    ...
    def received(self, received):
        """Sets the received of this EmailMessage.


        :param received: The received of this EmailMessage.  # noqa: E501
        :type: ModelDate
        """
    ...
    @property
    def size(self):
        """Gets the size of this EmailMessage.  # noqa: E501

        Content length in bytes of the original raw email message  # noqa: E501

        :return: The size of this EmailMessage.  # noqa: E501
        :rtype: float
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this EmailMessage.

        Content length in bytes of the original raw email message  # noqa: E501

        :param size: The size of this EmailMessage.  # noqa: E501
        :type: float
        """
    ...
    @property
    def ip(self):
        """Gets the ip of this EmailMessage.  # noqa: E501

        The remote SMTP server that send the mail to the server at `via`  # noqa: E501

        :return: The ip of this EmailMessage.  # noqa: E501
        :rtype: str
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        """Sets the ip of this EmailMessage.

        The remote SMTP server that send the mail to the server at `via`  # noqa: E501

        :param ip: The ip of this EmailMessage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def via(self):
        """Gets the via of this EmailMessage.  # noqa: E501

        IP address of SMTP server that received the message from `ip`  # noqa: E501

        :return: The via of this EmailMessage.  # noqa: E501
        :rtype: str
        """
        return self._via
    ...
    @via.setter
    def via(self, via):
        """Sets the via of this EmailMessage.

        IP address of SMTP server that received the message from `ip`  # noqa: E501

        :param via: The via of this EmailMessage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def folder(self):
        """Gets the folder of this EmailMessage.  # noqa: E501

        Inbox folder that this message has been put into  # noqa: E501

        :return: The folder of this EmailMessage.  # noqa: E501
        :rtype: str
        """
        return self._folder
    ...
    def folder(self, folder):
        """Sets the folder of this EmailMessage.

        Inbox folder that this message has been put into  # noqa: E501

        :param folder: The folder of this EmailMessage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this EmailMessage.  # noqa: E501

        Custom inbox labels created by the end user  # noqa: E501

        :return: The labels of this EmailMessage.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this EmailMessage.

        Custom inbox labels created by the end user  # noqa: E501

        :param labels: The labels of this EmailMessage.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def read(self):
        """Gets the read of this EmailMessage.  # noqa: E501

        Read/uread status. true=read, false=unread. Only set from the Inbox UI app.  # noqa: E501

        :return: The read of this EmailMessage.  # noqa: E501
        :rtype: bool
        """
        return self._read
    ...
    @read.setter
    def read(self, read):
        """Sets the read of this EmailMessage.

        Read/uread status. true=read, false=unread. Only set from the Inbox UI app.  # noqa: E501

        :param read: The read of this EmailMessage.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def rtls(self):
        """Gets the rtls of this EmailMessage.  # noqa: E501

        When true, indicates the SMTP message was received over TLS (encrypted).  # noqa: E501

        :return: The rtls of this EmailMessage.  # noqa: E501
        :rtype: bool
        """
        return self._rtls
    ...
    @rtls.setter
    def rtls(self, rtls):
        """Sets the rtls of this EmailMessage.

        When true, indicates the SMTP message was received over TLS (encrypted).  # noqa: E501

        :param rtls: The rtls of this EmailMessage.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def links(self):
        """Gets the links of this EmailMessage.  # noqa: E501

        List of any URLs that were found in the text and HTML body of the message.  # noqa: E501

        :return: The links of this EmailMessage.  # noqa: E501
        :rtype: list[str]
        """
        return self._links
    ...
    def links(self, links):
        """Sets the links of this EmailMessage.

        List of any URLs that were found in the text and HTML body of the message.  # noqa: E501

        :param links: The links of this EmailMessage.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def spam(self):
        """Gets the spam of this EmailMessage.  # noqa: E501
        ...
        :return: The spam of this EmailMessage.  # noqa: E501
        :rtype: float
        """
        return self._spam
    ...
    @spam.setter
    def spam(self, spam):
        """Sets the spam of this EmailMessage.

        Experimental - result of spam filter scan, between 0.0 and 1.0, where 1.0 indicates a high likelihood of being spam  # noqa: E501

        :param spam: The spam of this EmailMessage.  # noqa: E501
        :type: float
        """
