...
import client
from client.api.email_validation_api import EmailValidationApi  # noqa: E501
...
class TestEmailValidationApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = EmailValidationApi()  # noqa: E501
    ...
    def test_validate_addresses_bulk(self):
        """Test case for validate_addresses_bulk
